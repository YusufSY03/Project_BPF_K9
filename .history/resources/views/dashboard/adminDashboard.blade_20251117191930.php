...
<head>
  ...
  <style>
    :root {
      ...
      --text: #111827;
      --muted: #6b7280;
      --primary: #3b82f6; /* Warna biru baru */
      --danger: #ef4444;
      --success: #10b981;
      --radius: 10px;
    ...
    * { box-sizing: border-box; }
    ...
    .sidebar {
      width: 240px;
      background: #1f2937; /* Sidebar gelap */
      color: #e5e7eb;
      padding: 24px;
      height: 100vh;
      position: fixed;
...
<body>
  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <a href="{{ route('users.index') }}">Manajemen User</a> {{-- INI LINK BARU --}}
      <a href="#">Laporan</a>
      <a href="#">Pengaturan</a>
  ...
  <main class="main-content">
    <header class="header">
      <div>
        <h1>Dashboard</h1>
        <p style="margin:0; color:var(--muted);">Selamat datang kembali, {{ session('user_name') ?? 'Admin' }}!</p>
      </div>
    </header>
