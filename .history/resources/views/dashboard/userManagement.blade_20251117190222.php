...
<body>
  ...
  <main class="main-content">
    <header class="header">
      ...
      <a href="{{ route('owner.users.create') }}" class="btn btn-success">+ Tambah User Baru</a>
    </header>
          ...
          @forelse ($users as $user)
            <tr>
              ...
              <td class="action-buttons">
                ...
                <a href="{{ route('owner.users.edit', $user->id) }}" class="btn-edit">Edit</a>
                {{-- Arahkan action ke route 'destroy' dan kirim $user->id --}}
<form action="{{ route('owner.users.destroy', $user->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('Apakah Anda yakin ingin menghapus user ini? Data tidak bisa dikembalikan.');">
    @csrf
    @method('DELETE')
