...
.welcome-text {
  ...
  color: var(--text-color);
    ...
    /* =================================
       ...
       ================================= */
    .featured-menu { padding: 80px 0; text-align: center; }
    .featured-menu h2 { font-size: 2.5rem; margin-bottom: 48px; }
    .menu-grid {
      display: grid;
    ...
    .menu-card h3 { margin: 0 0 8px 0; font-size: 1.5rem; }
