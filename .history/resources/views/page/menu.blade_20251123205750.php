...
.welcome-text {
  ...
  color: var(--text-color);
    ...
    * { box-sizing: border-box; }
    ...
    .menu-card-body { padding: 24px; flex-grow: 1; }
   ...
   <section class="full-menu">
      <div class="container">
         <div class="menu-grid">
          ...
          <div class="menu-card">
            <img src="https://via.placeholder.com/300x220/f87171/FFFFFF?text=Ayam+Asam+Manis" alt="Ayam Asam Manis">
            <div class="menu-card-body">
              <div class="menu-card-header">
                <h3>Ayam Asam Manis</h3>
                <span class="price">Rp 15.000</span>
              </div>
              <p>Potongan ayam renyah dengan saus asam manis klasik yang segar.</p>
            </div>
          </div>

          <div class="menu-card">
            <img src="https://via.placeholder.com/300x220/dc2626/FFFFFF?text=Ayam+Korean+Spicy" alt="Ayam Korean Spicy">
            <div class="menu-card-body">
              <div class="menu-card-header">
                <h3>Ayam Korean Spicy</h3>
                <span class="price">Rp 15.000</span>
              </div>
              <p>Ayam goreng pedas manis ala Korea yang bikin ketagihan.</p>
            </div>
          </div>
          ...
          <div class="menu-card">
            <img src="https://via.placeholder.com/300x220/7f1d1d/FFFFFF?text=Ayam+BBQ" alt="Ayam BBQ">
            <div class="menu-card-body">
              <div class="menu-card-header">
                <h3>Ayam BBQ</h3>
                <span class="price">Rp 15.000</span>
              </div>
              <p>Ayam panggang dengan olesan saus barbekyu smoky yang khas.</p>
            </div>
          </div>

          <div class="menu-card">
            <img src="https://via.placeholder.com/300x220/a7f3d0/000000?text=Ayam+Suwir" alt="Ayam Suwir">
            <div class="menu-card-body">
              <div class="menu-card-header">
                <h3>Ayam Suwir</h3>
                <span class="price">Rp 15.000</span>
          ...
          <div class="menu-card">
            <img src="https://via.placeholder.com/300x220/facc15/000000?text=Michipop" alt="Michipop">
            <div class="menu-card-body">
              <div class="menu-card-header">
                <h3>Michipop</h3>
                <span class="price">Rp 18.000</span>
              </div>
              <p>Ayam popcorn renyah dengan bumbu rahasia Nyamaw.</p>
            </div>
          </div>

          <div class="menu-card">
            <img src="https://via.placeholder.com/300x220/fb923c/000000?text=Chicken+Wings" alt="Chicken Wings">
            <div class="menu-card-body">
              <div class="menu-card-header">
                <h3>Chicken Wings</h3>
                <span class="price">Rp 18.000</span>
              </div>
              <p>Sayap ayam goreng dengan pilihan saus BBQ atau pedas manis.</p>
            </div>
          </div>
